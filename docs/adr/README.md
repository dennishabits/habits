...
| [ADR-0019](0019-firestore-direct-agent-quality-reviewer.md) | Firestore direct voor agent-quality-reviewer — geen BigQuery-sync | Accepted | architectuur, agent, firestore, bigquery |
